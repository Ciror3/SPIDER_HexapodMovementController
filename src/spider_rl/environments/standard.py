...
try:
    import pygame
except ModuleNotFoundError:  # El render es opcional para entrenamiento headless.
    pygame = None
...
class SpiderEnv(gym.Env):
    ...
    def __init__(
        ...
        self.observation_space = gym.spaces.Box(
            # Los límites del mapa gobiernan el muestreo inicial. Como el robot
            # se mantiene en el origen, el target relativo puede salir de ellos.
