...
from spider_rl.environments.previous_action import ACTION_METADATA, SpiderEnv
from spider_rl.evaluation.compare import patch_numpy_pickle_aliases
...
def parse_args():
    ...
    parser.add_argument(
        "--ppo-model",
        default=str(PROJECT_ROOT / "models" / "previous_action" / "ppo_previous_action.zip"),
