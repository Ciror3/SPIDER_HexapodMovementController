...
def parse_args():
    ...
    parser.add_argument(
        ...
        help="standard usa los entornos base; previous_steps usa dinámica condicionada",
    )
    parser.add_argument(
        "--env",
...
def make_env(args):
    ...
    if args.env_mode == "previous_steps":
        from spider_rl.environments.previous_action import SpiderEnv

        return SpiderEnv(render_mode=None)

    from spider_rl.environments import get_env_class
